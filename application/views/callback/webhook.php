<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Riwayat Status Pembayaran Transfer To VA</li>
    </ol>
</nav>
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Riwayat Status Pembayaran Transfer To VA</h6>
...
<script src="<?= base_url() ?>assets/public/js/status_va.js"></script>
